...
// LOCAL DEVIATION from the component as published by remocn: the original line was
//   import { loadFont as loadMono } from "@remotion/google-fonts/JetBrainsMono";
// which fetches JetBrains Mono from fonts.gstatic.com at module scope. That host is
// blocked by this environment's egress policy, and because the import runs at module
// scope it failed EVERY composition in the bundle, not just this one. The same family
// is already vendored in this repo at public/fonts/JetBrainsMono-400.woff2 and
// registered by fonts-loader.js, so this reads it from there instead.
