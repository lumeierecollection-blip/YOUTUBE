...
import { planeOffset, cameraSafe } from "../../visual/composition.js";
// Re-exported so scenes keep importing their geometry from the stage they
// draw on. The MODEL lives in composition.js because node has to import it
// too (frame-bounds.mjs asserts against it) and node cannot load JSX —
// the same reason planeOffset lives there. One model, two callers.
export { cameraSafe };
